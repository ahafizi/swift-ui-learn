...
struct CertificateCard: View {
    ...
    var body: some View {
        ...
        .background(RadialGradient(gradient: Gradient(colors: [Color(#colorLiteral(red: 1, green: 0.3448806107, blue: 0.256488502, alpha: 0.8)).opacity(0.8), Color(#colorLiteral(red: 0.2980392157, green: 0, blue: 0.7843137255, alpha: 0.6)).opacity(0.2)]), center: .bottomTrailing, startRadius: 5, endRadius: 900))
    ...
    var certificateDateRow: some View {
        VStack(alignment: .leading, spacing: 4) {
